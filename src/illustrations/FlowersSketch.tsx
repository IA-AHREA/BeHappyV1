...
/**
 * "Compra flores." — prototype in a loose, continuous single-line sketch style
 * (inspired by hand-drawn one-line book illustrations), instead of the
 * geometric stick-figure style used elsewhere. Original linework, not traced.
 */
export default function FlowersSketch() {
  return (
    <IllustrationSvg>
      <PopIn>
        <DrawPath
