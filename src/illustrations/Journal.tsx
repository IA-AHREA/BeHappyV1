...
/** "Anota lo bueno de hoy." — an open journal being filled in, pen in hand. */
export default function Journal() {
  return (
    <IllustrationSvg>
      <PopIn>
        <DrawPath d="M36 70 L36 168 Q108 152 184 168 L184 70 Q108 86 36 70 Z" />
      ...
      <PopIn delay={0.6}>
        ...
        <WriteLoop delay={0.5} d="M124 122 q10 -6 18 0 q8 6 18 -2" />
        <path className="ink-line" d="M168 128 L188 96 l6 4 L174 132 l-8 3 z" />
      </PopIn>
      <PopIn delay={1}>
        <Loop kind="twinkle">
          <path className="accent-fill" d="M160 52 l3 8 l8 3 l-8 3 l-3 8 l-3 -8 l-8 -3 l8 -3 z" />
        </Loop>
      </PopIn>
    </IllustrationSvg>
  );
